...
import { fetchListedCategory } from '../utils/tmdb';
...
export const ShowListedCategory = ({ category, listType }) => {
    const [listedCategory, setlistedCategory] = useState([]);
    const [loaderStatus, setLoaderStatus] = useState(false);

    useEffect(() => {
        const fetchlistedCategory = async () => {
            setLoaderStatus(true)
            try {
                const listedCategory = await fetchListedCategory(category, listType);
                setlistedCategory(listedCategory);
            } catch (error) {
                console.error('Error fetching trending data:', error);
                setlistedCategory(null);
            } finally {
...
export default ShowListedCategory;
